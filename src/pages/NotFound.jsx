...
function NotFound() {
  return (
    <>
      <Helmet>
        <title>404 - Page Not Found | Deepak Majhee</title>
        <meta 
          name="description" 
          content="The page you're looking for doesn't exist or has been moved. Return to Deepak Majhee's portfolio website."
        />
